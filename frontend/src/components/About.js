...
export const About = () => (
    <Fragment>
        ...
        <p> In this project has been used different programming languajes and frameworks in both, backend and frontend developing the is a little bit more about that... </p>
        <h3>Flask</h3>
        <p>
